...
class StatusServletTest {
    ...
    void doGetTest() throws IOException {
        ...
        StatusServlet statusServlet = new StatusServlet(simpleServiceMock);
        statusServlet.doGet(new MyReq(status.getId()),new MyResp());
    ...
    void doPostTest() throws IOException {
        ...
        status.setNameStatus("ТЕСТ");
        status.setOrderNum(5);
        Mockito.when(simpleServiceMock.save(any())).thenReturn(status);

        StatusServlet statusServlet = new StatusServlet(simpleServiceMock);
        statusServlet.doPost(new MyReq(status.getNameStatus(), status.getOrderNum().toString()),new MyResp());
    ...
    void getAllTest() throws IOException {
        ...
        StatusServlet statusServlet = new StatusServlet(simpleServiceMock);
        statusServlet.doGet(new MyReq(), new MyResp());
    ...
    void doDeleteTest() throws IOException {
        ...
        StatusServlet statusServlet = new StatusServlet(simpleServiceMock);
        statusServlet.doDelete(new MyReq(id),new MyResp());
