...
class VacancyServletTest { //тут я не знаю что проверять, поэтому просто проверил, что методы вызываются несколько раз

    @Test
    void doGetTest() throws IOException {
        VacancyServlet servletMock = Mockito.mock();
