...
public class ContactServletTest { //тут я не знаю что проверять, поэтому просто проверил, что методы вызываются несколько раз

    @Test
    void doGetTest() throws IOException {
        ContactServlet servletMock = Mockito.mock();
